...
class CommunicationDetailController: UIViewController,UITableViewDelegate,PageNationDelegate,UpdateApiDelegate {
    ...
    @objc func attachmentAction(notification: Notification){
        ...
        if (attachment?.count)! > 1 {
            ...
            let vc = self.storyboard?.instantiateViewController(withIdentifier: "AttachmentListController") as! AttachmentListController
            vc.m_Attachment = attachment
